...
if __name__ == '__main__':
    ...
    print(
        f"In einfacher Genauigkeit: {sn.singlePrecision(res1Rec)}")  # SN1 (rekusiv) in einfacher Genauigkeit berechnet (siehe snTask) und ausgegeben
    print(
        f"In doppelter Genauigkeit: {sn.doublePrecision(res1Rec)}")  # SN1 (rekusiv) in doppelter Genauigkeit berechnet (siehe snTask) und ausgegeben
    print("SN1-Genauigkeiten mit For-Schleife:")
    print(
        f"In einfacher Genauigkeit: {sn.singlePrecision(res1For)}")  # SN1 (For-Schleife) in einfacher Genauigkeit berechnet (siehe snTask) und ausgegeben
    print(
        f"In doppelter Genauigkeit: {sn.doublePrecision(res1For)}")  # SN1 (For-Schleife) in doppelter Genauigkeit berechnet (siehe snTask) und ausgegeben
    # SN2
    ...
    sn.precision(res2Rec)  # SN2 (rekusiv) in einfacher und doppelter Genauigkeit ausgeben (siehe snTask)
